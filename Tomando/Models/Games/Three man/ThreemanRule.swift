...
class ThreemanRule: DrinkingGameRule {
...
//            return sum == 7
//        },
//        ThreemanRule(whoDrinks: .myself, result: "¡Tomas tú!") { state in
//            let sum = state.dices.reduce(0, +)
//            return sum == 11
//        },
//        ThreemanRule(whoDrinks: .right, result: "Toma el jugador a tu derecha") { state in
//            let sum = state.dices.reduce(0, +)
//            return sum == 9
//        },
